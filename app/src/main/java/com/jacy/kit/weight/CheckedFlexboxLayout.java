 ...
 * 可选中的FlexboxLayout
 */
public class CheckedFlexboxLayout extends FlexboxLayout implements Checkable {
    ...
    public CheckedFlexboxLayout(Context context) {
        this(context, null);
    }

    public CheckedFlexboxLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CheckedFlexboxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface BeforeCheckWatcher {
         ...
         * @return 是否可被选中
         */
        boolean beforeChange(CheckedFlexboxLayout cll, boolean isChecked);
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onChanged(CheckedFlexboxLayout cll, boolean isChecked);
    }
}
