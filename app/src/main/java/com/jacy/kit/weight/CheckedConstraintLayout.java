...
public class CheckedConstraintLayout extends ConstraintLayout implements Checkable {
    ...
    public CheckedConstraintLayout(Context context) {
        this(context, null);
    }
    ...
    public CheckedConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface BeforeCheckWatcher {
         ...
         * @return 是否可被选中
         */
        boolean beforeChange(CheckedConstraintLayout cll, boolean isChecked);
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onChanged(CheckedConstraintLayout cll, boolean isChecked);
    }
}
